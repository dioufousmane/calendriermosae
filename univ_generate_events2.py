...
# 🎓 Noms de formation à retirer des titres/descriptions
formations_regex = r"""
    (?:M\d?\s+)?                  
...
def extract_enseignant(text, title):
    # Cas spéciaux où on ne renseigne pas l’enseignant
...
def main():
    print("📡 Téléchargement du calendrier UNIV 2...")
