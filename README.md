...
📁 racine/ ├── .git/ # Répertoire Git ├── .github/ # Contient les workflows GitHub Actions ├── .env # Fichier d'environnement (non versionné) ├── esgt_events.json # Événements ESGT pour MOSAE1 ├── esgt_events2.json # Événements ESGT pour MOSAE2 ├── esgt_generate_events.py # Script Python pour ESGT ├── favicon.ico # Icône du site ├── icon.png # Icône personnalisée ├── index.html # Page principale MOSAE1 ├── MOSAE1.ics # Fichier ICS source pour MOSAE1 ├── mosae2.html # Page secondaire MOSAE2 ├── MOSAE2.ics # Fichier ICS source pour MOSAE2 ├── script.js # Logique JavaScript du calendrier ├── style.css # Feuille de style CSS ├── univ_events.json # Événements UNIV pour MOSAE1 ├── univ_events2.json # Événements UNIV pour MOSAE2 └── univ_generate_events.py # Script Python pour UNIV
